...
// Var used to calculate area 
// var p = geod.Polygon(false), i, calculations;
// var used to calculate perimeter
...
class Region 
{
    ...
    boundaryFencePosts(calculations)
    {
       ...
       // document.getElementById("postDistance").innerHTML= "Fence Span" + " " + "="+ " " + span;
        ...
        for(let y = 0; y <postCoordinates.length; y++){
            var point = {
                ...
                'geometry': {
                    'type': 'Point',
                    'coordinates': [postCoordinates[y][0],postCoordinates[y][1]]            //[e.lngLat.lng, e.lngLat.lat]
                },
                'properties': {
